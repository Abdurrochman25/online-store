...
type Cart struct {
	...
	UserID    null.Int16 `boil:"user_id" json:"user_id,omitempty" toml:"user_id" yaml:"user_id,omitempty"`
...
var CartWhere = struct {
	...
	ID:        whereHelperint{field: "\"carts\".\"id\""},
	UserID:    whereHelpernull_Int16{field: "\"carts\".\"user_id\""},
	ProductID: whereHelpernull_Int16{field: "\"carts\".\"product_id\""},
	Qty:       whereHelpernull_Int16{field: "\"carts\".\"qty\""},
...
func (r *cartR) GetProduct() *Product {
	if r == nil {
		return nil
	}
	return r.Product
...
var (
	cartAllColumns            = []string{"id", "user_id", "product_id", "qty", "created_at", "updated_at", "deleted_at"}
	cartColumnsWithoutDefault = []string{}
	cartColumnsWithDefault    = []string{"id", "user_id", "product_id", "qty", "created_at", "updated_at", "deleted_at"}
...
func (o *Cart) Product(mods ...qm.QueryMod) productQuery {
...
func (cartL) LoadProduct(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCart interface{}, mods queries.Applicator) error {
	var slice []*Cart
	var object *Cart
...
// SetProduct of the cart to the related item.
// Sets o.R.Product to related.
// Adds o to related.R.Carts.
func (o *Cart) SetProduct(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Product) error {
	var err error
	if insert {
...
func (o *Cart) RemoveProduct(ctx context.Context, exec boil.ContextExecutor, related *Product) error {
	var err error
...
func FindCart(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*Cart, error) {
	cartObj := &Cart{}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(cartPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert carts, could not build conflict column list")
			}
...
func CartExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
