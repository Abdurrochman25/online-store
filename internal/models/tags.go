...
func (r *tagR) GetProductTags() ProductTagSlice {
	if r == nil {
		return nil
	}
...
var (
	tagAllColumns            = []string{"id", "name", "description", "created_at", "updated_at", "deleted_at"}
	tagColumnsWithoutDefault = []string{}
	tagColumnsWithDefault    = []string{"id", "name", "description", "created_at", "updated_at", "deleted_at"}
...
func (o *Tag) ProductTags(mods ...qm.QueryMod) productTagQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"product_tags\".\"tag_id\"=?", o.ID),
	)
...
func (tagL) LoadProductTags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`product_tags.tag_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets o.R.Tag's ProductTags accordingly.
// Replaces o.R.ProductTags with related.
// Sets related.R.Tag's ProductTags accordingly.
func (o *Tag) SetProductTags(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ProductTag) error {
	query := "update \"product_tags\" set \"tag_id\" = null where \"tag_id\" = $1"
...
// Sets related.R.Tag.
func (o *Tag) RemoveProductTags(ctx context.Context, exec boil.ContextExecutor, related ...*ProductTag) error {
	if len(related) == 0 {
		return nil
	}
