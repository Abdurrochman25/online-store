...
type Order struct {
	...
	OrderDetail null.String `boil:"order_detail" json:"order_detail,omitempty" toml:"order_detail" yaml:"order_detail,omitempty"`
...
var OrderTableColumns = struct {
	...
	Qty:         "orders.qty",
	OrderDetail: "orders.order_detail",
...
var OrderWhere = struct {
	...
	OrderDetail whereHelpernull_String
	CreatedAt   whereHelpernull_Time
	UpdatedAt   whereHelpernull_Time
	DeletedAt   whereHelpernull_Time
}{
	ID:          whereHelperint{field: "\"orders\".\"id\""},
	UserID:      whereHelpernull_Int16{field: "\"orders\".\"user_id\""},
	ProductID:   whereHelpernull_Int16{field: "\"orders\".\"product_id\""},
	Qty:         whereHelpernull_Int16{field: "\"orders\".\"qty\""},
	OrderDetail: whereHelpernull_String{field: "\"orders\".\"order_detail\""},
...
var (
	orderAllColumns            = []string{"id", "user_id", "product_id", "qty", "order_detail", "created_at", "updated_at", "deleted_at"}
	orderColumnsWithoutDefault = []string{}
	orderColumnsWithDefault    = []string{"id", "user_id", "product_id", "qty", "order_detail", "created_at", "updated_at", "deleted_at"}
...
func (o *Order) RemoveProduct(ctx context.Context, exec boil.ContextExecutor, related *Product) error {
	var err error
