...
func (permissionL) LoadRolePermissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybePermission interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`role_permissions.permission_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets o.R.Permission's RolePermissions accordingly.
// Replaces o.R.RolePermissions with related.
// Sets related.R.Permission's RolePermissions accordingly.
func (o *Permission) SetRolePermissions(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RolePermission) error {
	query := "update \"role_permissions\" set \"permission_id\" = null where \"permission_id\" = $1"
...
func (o *Permission) RemoveRolePermissions(ctx context.Context, exec boil.ContextExecutor, related ...*RolePermission) error {
	if len(related) == 0 {
		return nil
	}
